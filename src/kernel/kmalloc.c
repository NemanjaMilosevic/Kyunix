...
//Experimental embarrassing stuff...
size_t getsize(void * p) {
    size_t * in = p;
    if (in) { --in; return *in; }
    return -1; // getsize shouldn't return -1 if the return type is declared unsigned – Jan Turoň Feb 11 at 15:56 
}
...
//We failed to allocate more memory, bail and return null
    return NULL; 
